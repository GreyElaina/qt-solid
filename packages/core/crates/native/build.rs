...
fn main() {
    ...
    println!("cargo:rerun-if-changed=src/qt/cpp/host/uv.cpp");
    println!("cargo:rerun-if-changed=src/qt/cpp/host/state.cpp");
    ...
    println!("cargo:rerun-if-changed=src/qt/cpp/macos/event_buffer.mm");
