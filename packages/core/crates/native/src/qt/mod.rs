...
pub(crate) use ffi::{
    ...
    qt_window_fullscreen, qt_window_is_fullscreen, qt_window_is_maximized, qt_window_is_minimized,
    qt_window_maximize, qt_window_minimize, qt_window_restore, qt_window_set_always_on_top,
    qt_window_set_enabled, qt_window_set_frameless, qt_window_set_height, qt_window_set_min_height,
